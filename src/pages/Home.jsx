    ...
    <div className="container text-center mt-5">
      ...
      <div className="row container bg-light bg-gradient justify-content-center py-3" id="difficulty-container">
        ...
        <div className="row col-8 difficulty-btn">
          ...
          <div className="row">
            <p className="card-text"><small className="text-body-secondary">Guess Between: 0 - 10</small></p>
          </div>
        </div>
        ...
        <div className="row col-8 difficulty-btn">
          ...
          <div className="row">
            <p className="card-text"><small className="text-body-secondary">Guess Between: 0 - 100</small></p>
          </div>
        </div>
        ...
        <div className="row col-8 difficulty-btn">
          ...
          <div className="row">
            <p className="card-text"><small className="text-body-secondary">Guess Between: 0 - 1,000</small></p>
          </div>
        </div>
